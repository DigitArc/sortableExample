...
var mainContainer = _jquery.default.parseHTML("<ul data-list=\"main-list\" class=\"list-group\"></ul>")[0];
...
var opts = {
  ...
  onEnd: function onEnd(e) {
    ...
    console.log(_data.people); //console.log(people.splice(people.indexOf(movedItem), 1));
    //console.log(people);
  }
};
var items = (0, _jquery.default)(".list-group");

_sortablejs.default.create(items[0], opts);

_sortablejs.default.create(items[1], opts);

_sortablejs.default.create(items[2], opts);

console.log(items[1]); // items.map((item) => Sortable.create(item, opts));
